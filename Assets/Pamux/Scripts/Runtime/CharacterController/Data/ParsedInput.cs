...
namespace Pamux.Lib.Unity.Commons
{
    public class ParsedInput
    {
        ...
        public float TargetHorizontalSpeed => this.HasMove
            ? (this.isSprintPressed ? this.pcc.ActiveLocomotionZoneParameters.SprintSpeed : this.pcc.ActiveLocomotionZoneParameters.MoveSpeed)
            : 0.0f;
        ...
        private PamuxPlayerInputActions pamuxPlayerInputActions;

        public ParsedInput(PamuxCharacterController pcc) {
            this.pcc = pcc;

            this.pamuxPlayerInputActions = new PamuxPlayerInputActions();
        }

        public void Enable() {
            this.pamuxPlayerInputActions.Enable();
        }

        public void Disable() {
            this.pamuxPlayerInputActions.Disable();
        }

        //https://docs.unity3d.com/Packages/com.unity.inputsystem@1.4/manual/Components.html

        public void Initialize() {
            var cc = this.pamuxPlayerInputActions.CharacterControls;
